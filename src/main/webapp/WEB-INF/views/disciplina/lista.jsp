...
<c:set var="pageTitle" value="Gestão de Disciplinas" />
      ...
      <div class="container">
        ...
        <div class="page-header">
          <section class="mb-4">
            ...
            <p class="page-subtitle">Gerencie as unidades curriculares da instituição.</p>
          </section>
          
          <div class="btn-row">
             <a href="disciplinas?action=novo" class="btn btn-primary btn-sm">
                Nova Disciplina
             </a>
          </div>
        </div>
              ...
              <tbody>
                <c:forEach var="disciplina" items="${disciplinas}">
                  <tr>
                    ...
                    <td><c:out value="${disciplina.semestre}" /></td>
                    <td><c:out value="${disciplina.curso.nome}" /></td>
                    <td class="actions">
                      <a href="disciplinas?action=editar&id=${disciplina.id}">Editar</a>
                      <a href="disciplinas?action=excluir&id=${disciplina.id}" 
