          ...
          <c:forEach var="avaliacao" items="${pendentes}">
            <article class="card card-padding card-course">
              <div class="top">
                ...
                <div>
                  <h2 class="title"><c:out value="${avaliacao.turma.disciplina.nome}"/></h2>
                  <%-- Assumindo 1 professor por turma; precisa ajustar se for mais --%>
                  <c:forEach var="prof" items="${avaliacao.turma.professores}" begin="0" end="0">
                     <div class="meta">Professor(a): <c:out value="${prof.nome}"/></div>
                  </c:forEach>
                </div>
              </div>
              <div>
                <%-- Badge "Não respondido" [cite: 66-67] --%>
              ...
              <div class="actions">
                <%-- O link agora aponta para o servlet de resposta --%>
            ...
            <article class="card card-padding card-course">
              ...
              <div>
                ...
                <span class="badge badge-success">
                  ...
                  Respondido
                  <%-- TODO: Adicionar data da resposta se necessário --%>
                </span>
              </div>
              <div class="actions">
