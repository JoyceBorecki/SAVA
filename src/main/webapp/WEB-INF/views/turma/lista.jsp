              ...
              <tbody>
                <c:forEach var="turma" items="${turmas}">
                  <tr>
                    ...
                    <td>${fn:length(turma.alunos)}</td> <%-- Contagem de alunos --%>
                    <td class="actions">
                      <%-- Link para o gerenciamento de alunos/professores (futuro) --%>
                      <%-- <a href="turmas?action=gerenciar&id=${turma.id}">Gerenciar</a> --%>
