...
<c:set var="pageTitle" value="Processos Avaliativos" />
    ...
    <main class="page-wrap">
      <div class="container">
        ...
        <div class="page-header">
          <section class="mb-4">
            <h1 class="page-title">Processos Avaliativos</h1>
            <p class="page-subtitle">Gerencie os períodos de avaliação (ex: 2025/2).</p>
          </section>
          
          <div class="btn-row">
             <a href="processos?action=novo" class="btn btn-primary btn-sm">
                Novo Processo
             </a>
          </div>
        </div>
            ...
            <table class="data-table">
              ...
              <tbody>
                <c:forEach var="processo" items="${processos}">
                  <tr>
                    <td><c:out value="${processo.nome}" /></td>
                    <td><c:out value="${processo.dataInicio}" /></td>
                    <td><c:out value="${processo.dataFim}" /></td>
                    <td class="actions">
                      <a href="processos?action=editar&id=${processo.id}">Editar</a>
                      <a href="processos?action=excluir&id=${processo.id}" 
